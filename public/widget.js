(function () {
  ...
  style.textContent = `
    ...
    .cw-msg-row.user  .cw-bubble { background: #2563eb; color: #fff; border-radius: 18px 18px 4px 18px; }
    ...
    .cw-product { background: #dbeafe; border-radius: 8px; padding: 7px 10px; font-size: 0.82rem; cursor: pointer; color: #1e40af; transition: background 0.15s; }
    ...
    .cw-spinner { width: 12px; height: 12px; border: 2px solid #d1d5db; border-top-color: #2563eb; border-radius: 50%; animation: cw-spin 0.8s linear infinite; flex-shrink: 0; }
    ...
    #cw-input:focus { border-color: #2563eb; box-shadow: 0 0 0 3px rgba(37,99,235,0.1); }
    #cw-send { padding: 9px 14px; background: #2563eb; color: #fff; border: none; border-radius: 8px; cursor: pointer; font-size: 0.875rem; font-weight: 500; transition: background 0.2s; }
    ...
    .cw-det-cat { font-size: 0.7rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.08em; color: #2563eb; }
    ...
    .cw-det-link { display: block; text-align: center; padding: 9px 14px; background: #2563eb; color: #fff !important; border-radius: 8px; text-decoration: none !important; font-size: 0.875rem; font-weight: 500; transition: background 0.2s; }
    .cw-det-link:hover { background: #1d4ed8; }
  `;
